...
if($namafoto != null){
    ...
    $terupload = move_uploaded_file($file_tmp, 'assets/paket_1/'.$namafoto);
}else{
...
$query = mysqli_query($koneksi,"UPDATE paket1 SET tgl_uploadfoto='$tgl_uploadfoto', username='$username', foto_paket1='$namafoto' where id='$id'");
