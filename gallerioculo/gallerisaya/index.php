...
<body id="page-top">
            ...
            <li class="nav-item active">
                ...
                <div id="collapsePages2" class="collapse" aria-labelledby="headingPages3"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="/gate/admin/gallerioculo/gallerisaya/"><b>Galleri Saya</b></a>
            ...
            <div class="col-lg-9 col-md-9 mb-4">
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h5 class="m-0 font-weight-bold text-primary" align="center">Galleri Saya</h5>
                    </div>
                    <div class="card-body">
                                    <?php
                                    ...
                                    ?>
                                        <!-- Scrip Modal Tambah Data-->  
	                                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal0"><i class="fas fa-plus-circle"></i> Tambah Galleri</button>
	                                        <!-- Modal -->
				                            ...
				                            <div class="modal-header">
				                                <h5 class="modal-title">Tambah Galleri</h5>
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="inputkegiatan" name="nama_galleri" placeholder="Masukkan nama kegiatan" required>
                                            </div>
                                            </div>
                                            <div class="row mb-3">
                                                <label for="inputpasangan" class="col-sm-2 col-form-label">Pasangan</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="inputpasangan" name="keterangan_galleri" placeholder="Masukkan nama pasangan" required>
                                            </div>
                                            </div>
                                            <div class="row mb-3">
                                                <label for="inputtipeketerangan" class="col-sm-2 col-form-label">Tipe Keterangan</label>
                                            <div class="col-sm-10">
                                                <select name="tipe_keterangan" class="form-control" id="inputtipeketerangan" class="form-select" required>
                                                    <option value="" disabled selected>Pilih Tipe Keterangan</option>
                                            ...
                                            <div class="col-sm-10">
                                                <select name="tipe_foto" class="form-control" id="inputkategori" class="form-select" required>
                                            ...
                                            <div class="col-sm-10">
                                                <input type="hidden" class="form-control" name="tgl_upload" value="<?php echo date('Y-m-d H:i:s', time() + (210 * 120)); ?>">
                                            </div>
                                            <div class="col-sm-10">
                                                <input type="hidden" class="form-control" name="tgl_aktivitas" value="<?php echo date('Y-m-d H:i:s', time() + (210 * 120)); ?>">
                                            </div>
                                            <div class="col-sm-10">
                                                <input type="hidden" class="form-control" name="tgl" value="<?php echo date('Y-m-d H:i:s', time() + (210 * 120)); ?>">
                                            </div>
                                            <div>
                                                <input type="hidden" class="form-control" name="username" value="<?php echo htmlspecialchars("$data_admin[username]");?>">
                                            </div>
                                            </div>
				                            <!-- footer modal -->
                        ...
                        <!-- Script Fitur Pencarian -->
                            <form action="<?php echo $_SERVER["PHP_SELF"];?>" method="get" class="d-flex">
                                <input type="text" name="cari" class="form-control me-2" aria-label="Search" placeholder="Cari nama kegiatan, nama pasangan atau tanggal upload">
                        ...
                        <!-- Script Notif Update Data -->
                                    ...
                                    <?php 
	                                    if(isset($_GET['pesan'])){
                                        if($_GET['pesan']=="hapusgalleri"){
			                                echo "<div class='alert2'>Data galleri telah dihapus <i class='fa fa-check'></i></div>";
                                        }else if($_GET['pesan'] == "tambahgalleri"){
                                            echo "<div class='alert'>Data galleri telah ditambah <i class='fa fa-check'></i></div>";
                                        }else if($_GET['pesan'] == "uploadfoto"){
                                            echo "<div class='alert'>Upload Foto telah berhasil <i class='fa fa-check'></i></div>";
                                        }else if($_GET['pesan'] == "perbaharuigalleri"){
                                            echo "<div class='alert'>Data galleri telah diperbaharui <i class='fa fa-check'></i></div>";
                                            }
	                                    }
	                                ?>
                            ...
                            <div class="table-responsive">
                                ...
                                <tbody>
                                    <thead>
                                        <tr>
                                            ...
                                            <th><center>Pasangan</center></th>
                                            <th><center>Tipe Keterangan</center></th>
                                    ...
                                    <?php
			                        	...
			                        	$lanjut = $halaman + 1;
				                        $id = 1;
				                        $data = mysqli_query($koneksi,"select * from gallerisaya");
				                        $jumlah_data = mysqli_num_rows($data);
				                        $total_halaman = ceil($jumlah_data / $batas);
				                        $sql = mysqli_query($koneksi,"select * from gallerisaya limit $halaman_awal, $batas");
				                        $id= $halaman_awal+1;
				                        
				                        if(isset($_GET['cari'])){
		                                $cari = $_GET['cari'];
		                                $sql = mysqli_query($koneksi,"SELECT * FROM gallerisaya WHERE nama_galleri like '%".$cari."%' OR keterangan_galleri like '%".$cari."%' OR tgl_upload like '%".$cari."%' ORDER BY id ASC");
	                                    }else{
		                                $data = mysqli_query($koneksi,"SELECT * FROM gallerisaya ORDER BY id ASC");
	                                    }
				                	...
				                	?>
                                        <tr>
                                            ...
                                            <th><center><?php echo htmlspecialchars($resl['nama_galleri']); ?></center></th>
                                            <th><center><?php echo htmlspecialchars($resl[ 'keterangan_galleri']); ?></center></th>
                                            <th><center><?php echo htmlspecialchars($resl[ 'tipe_keterangan']); ?></center></th>
                                            <th><center><?php echo htmlspecialchars($resl[ 'tipe_foto']); ?></center></th>
                                            <th><center><img src="assets/galleri_saya/<?=htmlspecialchars($resl['foto_gallerisaya'])?>" alt="" width="150"></center></th>
                                            <th><center><?php echo date('d F Y | H:i A',strtotime($resl['tgl_upload'])); ?></center></th>
                                            <th><center>
                                                
                                                <!-- Scrip Modal Perbaharui-->
                                            <a href="" data-toggle="modal" data-target="#myModal2<?= htmlspecialchars($resl['id']); ?>"><button type="button" class="btn btn-success"><i class="fas fa-edit"></i> Edit</button></a>
	                                        <!-- Modal -->
	                                        <div class="modal fade" id="myModal2<?= htmlspecialchars($resl['id']); ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" role="dialog">
		                                    <div class="modal-dialog">
			                                <!-- konten modal-->
			                                <div class="modal-content">
				                            <!-- heading modal -->
				                            <div class="modal-header">
				                                <h5 class="modal-title">Perbaharui Data Galleri</h5>
					                            <button type="button" class="close" data-dismiss="modal">&times;</button>
				                            </div>
				                            <!-- body modal -->
				                            <div class="modal-body">
				                                <form class="forms-sample" action="pembaharuan.php" method="POST" enctype="multipart/form-data">
                                            <div class="col-sm-10">
                                                <input type="hidden" class="form-control" readonly="" name="id" value="<?= htmlspecialchars("$resl[id]");?>">
                                            </div>
                                            <div class="row mb-3">
                                                <label for="inputkegiatan" class="col-sm-2 col-form-label">Kegiatan</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" name="nama_galleri" value="<?= htmlspecialchars("$resl[nama_galleri]");?>" placeholder="Masukkan nama kegiatan">
                                            </div>
                                            </div>
                                            <div class="row mb-3">
                                                <label for="inputkegiatan" class="col-sm-2 col-form-label">Pasangan</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" name="keterangan_galleri" value="<?= htmlspecialchars("$resl[keterangan_galleri]");?>" placeholder="Masukkan nama pasangan">
                                            </div>
                                            </div>
                                            <div class="row mb-3">
                                                <label for="inputtipeketerangan" class="col-sm-2 col-form-label">Tipe Keterangan</label>
                                            ...
                                            <div class="col-sm-10">
                                                <input type="hidden" class="form-control" name="keterangan_log" value="Perbaharui Data Galleri">
                                            </div>
				                            </div>
				                            <!-- footer modal -->
				                            <div class="modal-footer">
	                                ...
	                                <!--End Scrip Modal Perbaharui-->
                                                ...
                                                <!-- Scrip Modal Upload Foto-->
                                            <a href="" data-toggle="modal" data-target="#myModal<?= htmlspecialchars($resl['id']); ?>"><button type="button" class="btn btn-success"><i class="fa fa-upload"></i> Upload</button></a>
	                                        <!-- Modal -->
	                                        <div class="modal fade" id="myModal<?= htmlspecialchars($resl['id']); ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" role="dialog">
		                                    <div class="modal-dialog">
			                                <!-- konten modal-->
			                                <div class="modal-content">
				                            <!-- heading modal -->
				                            <div class="modal-header">
				                                <h5 class="modal-title">Upload Foto Galleri</h5>
					                            <button type="button" class="close" data-dismiss="modal">&times;</button>
				                            </div>
				                            <!-- body modal -->
				                            <div class="modal-body">
                                            ...
                                            <div class="row mb-3">
                                                <label for="inputfotogalleri" class="col-sm-2 col-form-label">Upload Foto</label>
                                            <div class="col-sm-10">
                                                <input type="file" class="form-control" name="gambar" accept=".jpg, .jpeg, .png" required>
                                                <input type="hidden" name="fotolama" value="<?= htmlspecialchars($resl['foto_gallerisaya']) ?>">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="hidden" class="form-control" name="keterangan_log" value="Upload Foto Galleri">
                                            </div>
				                            </div>
				                            <!-- footer modal -->
				                            <div class="modal-footer">
	                                ...
	                                <!--End Scrip Modal Upload Foto-->
	                                
                                                <!-- Scrip Modal Hapus-->
                                            <a href="" class="btn btn-danger" data-toggle="modal" data-target="#myModal1<?php echo htmlspecialchars($resl['id']); ?>"><i class="fas fa-trash-alt"></i> Hapus</a>
	                                        <!-- Modal -->
                                        ...
                                        <?php
                                                ...
                                                echo '<tr><th colspan="8"><center><font color="#c80000">Tidak ada data, silahkan masukkan nama kegiatan, nama pasangan & tanggal upload kembali &#128522;</font></center></th></tr>';
                                            }?>
                                    </tbody>
                                </table>
                                ...
                                <p><font color="blue" size="3"><b>Ukuran Foto :</b></br>Width: 1080px | Height: 720px</br>Resolution: (72 ppi) | Format: Transparent </b></font></p>
                                
                                <!-- Script menampilkan total data -->               
                                    <?php 
                                        $tampil = "SELECT * FROM gallerisaya";
    ...
    <script>
	    history.pushState({}, "", '/gate/admin/gallerioculo/gallerisaya/');
	</script>
