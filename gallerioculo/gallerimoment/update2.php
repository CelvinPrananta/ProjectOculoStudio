...
if($namafoto != null){
    ...
    $terupload = move_uploaded_file($file_tmp, 'assets/moment_2/'.$namafoto);
}else{
...
$query = mysqli_query($koneksi,"UPDATE highlight2 SET tgl_aktivitas='$tgl_aktivitas', username='$username', foto_galleri2='$namafoto' where id='$id'");
...
header("location:/gate/admin/gallerioculo/gallerimoment/?pesan=perbaharuigalleri2");
?>