...
<body id="page-top">
            ...
            <li class="nav-item active">
                ...
                <div id="collapsePages4" class="collapse" aria-labelledby="headingPages3"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="/gate/admin/riwayataktivitas/riwayat-aktivitas-profil/"><b>Data Pribadi</b></a>
                    </div>
                </div>
            </li>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <section id="riwayat" class="container-fluid">
                <style>
                    ...
                    <!-- Page Heading -->
                    <h1 class="h4 mb-2 text-gray-800">Aktivitas Data Pribadi</h1>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <!-- Script Fitur Pencarian -->
                            <form action="<?php echo $_SERVER["PHP_SELF"];?>" method="get" class="d-flex">
                                <input type="text" name="cari" class="form-control me-2" aria-label="Search" placeholder="Cari nama lengkap, email atau nama pengguna">
                            ...
                            <div class="table-responsive">
                                ...
                                <tbody>
                                    ...
                                    <?php
			                        	...
			                        	$lanjut1 = $halaman1 + 1;
				                        $id_log = 1;
				                        $data1 = mysqli_query($koneksi,"select * from log_userdata4");
				                        $jumlah_data1 = mysqli_num_rows($data1);
				                        $total_halaman1 = ceil($jumlah_data1 / $batas1);
				                        $sql1 = mysqli_query($koneksi,"select * from log_userdata4 limit $halaman_awal1, $batas1");
				                        $id_log= $halaman_awal1+1;
				                        
				                        if(isset($_GET['cari'])){
		                                $cari = $_GET['cari'];
		                                $sql1 = mysqli_query($koneksi,"SELECT * FROM log_userdata4 WHERE namleng like '%".$cari."%' OR email like '%".$cari."%' OR username like '%".$cari."%' OR keterangan_log like '%".$cari."%' ORDER BY id_log ASC");
	                                    }else{ 
		                                $data1 = mysqli_query($koneksi,"SELECT * FROM log_userdata4 ORDER BY id_log ASC");
	                                    }
				                	...
				                	?>
                                        <tr>
                                            ...
                                            <th><center><?php echo htmlspecialchars($resl1[ 'foto']); ?></center></th>
                                        ...
                                        <?php
                                                ...
                                                echo '<tr><th colspan="8"><center><font color="FF0000">Tidak ada data, silahkan masukkan nama lengkap, email & nama pengguna kembali &#128522;</font></center></th></tr>';
                                            }?>
                                    </tbody>
                                </table>
                                ...
                                <!-- Script menampilkan total data -->               
                                    <?php 
                                        $tampil1 = "SELECT * FROM log_userdata4";
    ...
    <script>
	  history.pushState({}, "", '/gate/admin/riwayataktivitas/riwayat-aktivitas-profil/');
	</script>
