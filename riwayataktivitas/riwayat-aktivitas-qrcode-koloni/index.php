...
<body id="page-top">
            ...
            <li class="nav-item active">
                ...
                <div id="collapsePages4" class="collapse" aria-labelledby="headingPages3"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="/gate/admin/riwayataktivitas/riwayat-aktivitas-qrcode-koloni/"><b>QR Code (Koloni)</b></a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <section id="riwayat" class="container-fluid">
                <style>
                    ...
                    <!-- Page Heading -->
                    <h1 class="h4 mb-2 text-gray-800">Aktivitas QR Code Koloni</h1>
                            ...
                            <div class="table-responsive">
                                ...
                                <tbody>
                                    ...
                                    <?php
			                        	...
			                        	$lanjut2 = $halaman2 + 1;
				                        $id = 1;
				                        $data2 = mysqli_query($koneksi,"select * from log_qrcode");
				                        $jumlah_data2 = mysqli_num_rows($data2);
				                        $total_halaman2 = ceil($jumlah_data2 / $batas2);
				                        $sql2 = mysqli_query($koneksi,"select * from log_qrcode limit $halaman_awal2, $batas2");
				                        $id = $halaman_awal2+1;
				                        
				                        if(isset($_GET['cari'])){
		                                $cari = $_GET['cari'];
		                                $sql2 = mysqli_query($koneksi,"SELECT * FROM log_qrcode WHERE username like '%".$cari."%' OR idqrcode like '%".$cari."%' OR keterangan_log like '%".$cari."%' ORDER BY id ASC");
	                                    }else{
		                                $data2 = mysqli_query($koneksi,"SELECT * FROM log_qrcode ORDER BY id ASC");
	                                    }
                                ...
                                <!-- Script menampilkan total data -->               
                                    <?php 
                                        $tampil2 = "SELECT * FROM log_qrcode";
    ...
    <script>
	  history.pushState({}, "", '/gate/admin/riwayataktivitas/riwayat-aktivitas-qrcode-koloni/');
	</script>    
