...
if($namafoto != null){
    ...
    $terupload = move_uploaded_file($file_tmp, 'assets/paket_5/'.$namafoto);
}else{
...
$query = mysqli_query($koneksi,"UPDATE paket5 SET tgl_uploadfoto='$tgl_uploadfoto', username='$username', foto_paket5='$namafoto' where id='$id'");
...
header("location:/gate/admin/halaman-utama/?pesan=perbaharuipaket5");
?>