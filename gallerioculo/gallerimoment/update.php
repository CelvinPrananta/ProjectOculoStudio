...
if($namafoto != null){
    ...
    $terupload = move_uploaded_file($file_tmp, 'assets/moment_1/'.$namafoto);
}else{
...
$query = mysqli_query($koneksi,"UPDATE highlight1 SET tgl_aktivitas='$tgl_aktivitas', username='$username', foto_galleri1='$namafoto' where id='$id'");
...
header("location:/gate/admin/gallerioculo/gallerimoment/?pesan=perbaharuigalleri1");
?>