...
<body id="page-top">
            ...
            <li class="nav-item active">
                ...
                <div id="collapsePages4" class="collapse" aria-labelledby="headingPages3"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="/gate/admin/riwayataktivitas/riwayat-aktivitas-koloni/"><b>Koloni</b></a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <section id="riwayat" class="container-fluid">
                <style>
                    ...
                    <!-- Page Heading -->
                    <h1 class="h4 mb-2 text-gray-800">Aktivitas Koloni</h1>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <!-- Script Fitur Pencarian -->
                            <form action="<?php echo $_SERVER["PHP_SELF"];?>" method="get" class="d-flex">
                                <input type="text" name="cari" class="form-control me-2" aria-label="Search" placeholder="Cari penyunting, id koloni, atau jenis aktivitas">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <tbody>
                                    <thead>
                                        <tr>
                                            ...
                                            <th><center>ID Koloni</center></th>
                                            <th><center>Status Koloni</center></th>
                                            <th><center>Jumlah Panen (ml)</center></th>
                                    ...
                                    <?php
			                        	...
			                        	$lanjut2 = $halaman2 + 1;
				                        $id_log_koloni = 1;
				                        $data2 = mysqli_query($koneksi,"select * from log_koloni");
				                        $jumlah_data2 = mysqli_num_rows($data2);
				                        $total_halaman2 = ceil($jumlah_data2 / $batas2);
				                        $sql2 = mysqli_query($koneksi,"select * from log_koloni limit $halaman_awal2, $batas2");
				                        $id_log_koloni= $halaman_awal2+1;
				                        
				                        if(isset($_GET['cari'])){
		                                $cari = $_GET['cari'];
		                                $sql2 = mysqli_query($koneksi,"SELECT * FROM log_koloni WHERE idqrcode like '%".$cari."%' OR username like '%".$cari."%' OR keterangan_log like '%".$cari."%' ORDER BY id_log_koloni ASC");
	                                    }else{
		                                $data2 = mysqli_query($koneksi,"SELECT * FROM log_koloni ORDER BY id_log_koloni ASC");
	                                    }
				                	...
				                	?>
                                        <tr>
                                            <th><center><?php echo htmlspecialchars($id_log_koloni++); ?></center></th>
                                            <th><center><?php echo htmlspecialchars($resl2[ 'username']); ?></center></th>
                                            <th><center><?php echo htmlspecialchars($resl2[ 'idqrcode']); ?></center></th>
                                            <th><center><?php echo htmlspecialchars($resl2[ 'status']); ?></center></th>
                                            <th><center><?php echo htmlspecialchars($resl2[ 'jmlh_panen']); ?></center></th>
                                            <th><center><?php echo htmlspecialchars($resl2[ 'keterangan']); ?></center></th>
                                        ...
                                        <?php
                                                ...
                                                echo '<tr><th colspan="8"><center><font color="FF0000">Tidak ada data, silahkan masukkan penyunting, id koloni, & jenis aktivitas kembali &#128522;</font></center></th></tr>';
                                            }?>
                                    </tbody>
                                </table>
                                ...
                                <!-- Script menampilkan total data -->               
                                    <?php 
                                        $tampil2 = "SELECT * FROM log_koloni";
    ...
    <script>
	  history.pushState({}, "", '/gate/admin/riwayataktivitas/riwayat-aktivitas-koloni/');
	</script>
