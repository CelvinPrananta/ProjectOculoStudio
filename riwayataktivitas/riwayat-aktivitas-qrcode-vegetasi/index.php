...
<body id="page-top">
            ...
            <li class="nav-item active">
                ...
                <div id="collapsePages4" class="collapse" aria-labelledby="headingPages3"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="/gate/admin/riwayataktivitas/riwayat-aktivitas-qrcode-vegetasi/"><b>QR Code (Vegetasi)</b></a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <section id="riwayat" class="container-fluid">
                <style>
                    ...
                    <!-- Page Heading -->
                    <h1 class="h4 mb-2 text-gray-800">Aktivitas QR Code Vegetasi</h1>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <!-- Script Fitur Pencarian -->
                            <form action="<?php echo $_SERVER["PHP_SELF"];?>" method="get" class="d-flex">
                                <input type="text" name="cari" class="form-control me-2" aria-label="Search" placeholder="Cari penyunting, id data, atau jenis aktivitas">
                                <labelsearch2 for="search2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="form-control2" class="bi bi-search-heart-fill" viewBox="0 0 16 16">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <tbody>
                                    <thead>
                                        <tr>
                                            ...
                                            <th><center>ID Data</center></th>
                                            <th><center>Nama Data</center></th>
                                            <th><center>QR Code (ID)</center></th>
                                    ...
                                    <?php
			                        	...
			                        	$lanjut2 = $halaman2 + 1;
				                        $id = 1;
				                        $data2 = mysqli_query($conn,"select * from log_qrcode2");
				                        $jumlah_data2 = mysqli_num_rows($data2);
				                        $total_halaman2 = ceil($jumlah_data2 / $batas2);
				                        $sql2 = mysqli_query($conn,"select * from log_qrcode2 limit $halaman_awal2, $batas2");
				                        $id = $halaman_awal2+1;
				                        
				                        if(isset($_GET['cari'])){
		                                $cari = $_GET['cari'];
		                                $sql2 = mysqli_query($conn,"SELECT * FROM log_qrcode2 WHERE username like '%".$cari."%' OR idqrcode like '%".$cari."%' OR keterangan_log like '%".$cari."%' ORDER BY id ASC");
	                                    }else{
		                                $data2 = mysqli_query($conn,"SELECT * FROM log_qrcode2 ORDER BY id ASC");
	                                    }
				                	...
				                	?>
                                        <tr>
                                            ...
                                            <th><center><?php echo htmlspecialchars($resl2[ 'idqrcode']); ?></center></th>
                                            <th><center><?php echo htmlspecialchars($resl2[ 'nama']); ?></center></th>
                                            <th><center><?php echo htmlspecialchars($resl2[ 'gbrqrcode']); ?></center></th>
                                            <th><center><?php echo date('d F Y | H:i A',strtotime($resl2['tgl'])); ?></center></th>
                                            <th><center><?php echo htmlspecialchars($resl2[ 'keterangan_log']); ?></center></th>
                                        </tr>
                                        <?php
                                            }}else{
                                                echo '<tr><th colspan="7"><center><font color="FF0000">Tidak ada data, silahkan masukkan penyunting, id data, & jenis aktivitas kembali &#128522;</font></center></th></tr>';
                                            }?>
                                    </tbody>
                                </table>
                                ...
                                <!-- Script menampilkan total data -->               
                                    <?php 
                                        $tampil2 = "SELECT * FROM log_qrcode2";
            ...
            <section id="riwayat" class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <!-- Script Fitur Pencarian -->
                            <form action="<?php echo $_SERVER["PHP_SELF"];?>" method="get" class="d-flex">
                                <input type="text" name="cari1" class="form-control me-2" aria-label="Search" placeholder="Cari penyunting, id data, atau jenis aktivitas">
                                <labelsearch2 for="search2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="form-control2" class="bi bi-search-heart-fill" viewBox="0 0 16 16">
                                    <path d="M6.5 13a6.474 6.474 0 0 0 3.845-1.258h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.008 1.008 0 0 0-.115-.1A6.471 6.471 0 0 0 13 6.5 6.502 6.502 0 0 0 6.5 0a6.5 6.5 0 1 0 0 13Zm0-8.518c1.664-1.673 5.825 1.254 0 5.018-5.825-3.764-1.664-6.69 0-5.018Z"/>
                                </svg>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <tbody>
                                    <thead>
                                        <tr>
                                            ...
                                            <th><center>ID Data</center></th>
                                            <th><center>Nama Data</center></th>
                                            <th><center>QR Code (Link)</center></th>
                                            <th><center>Tanggal Aktivitas</center></th>
                                            <th><center>Jenis Aktivitas</center></th>
                                        </tr>
                                    </thead>
                                    <?php
			                        	...
			                        	$lanjut1 = $halaman1 + 1;
				                        $id = 1;
				                        $data1 = mysqli_query($conn,"select * from log_qrcode3");
				                        $jumlah_data1 = mysqli_num_rows($data1);
				                        $total_halaman1 = ceil($jumlah_data1 / $batas1);
				                        $sql1 = mysqli_query($conn,"select * from log_qrcode3 limit $halaman_awal1, $batas1");
				                        $id = $halaman_awal1+1;
				                        
				                        if(isset($_GET['cari1'])){
		                                $cari1 = $_GET['cari1'];
		                                $sql1 = mysqli_query($conn,"SELECT * FROM log_qrcode3 WHERE username like '%".$cari1."%' OR idqrcode like '%".$cari1."%' OR keterangan_log like '%".$cari1."%' ORDER BY id ASC");
	                                    }else{
		                                $data1 = mysqli_query($conn,"SELECT * FROM log_qrcode3 ORDER BY id ASC");
	                                    }
				                	...
				                	?>
                                        <tr>
                                            ...
                                            <th><center><?php echo htmlspecialchars($resl1[ 'idqrcode']); ?></center></th>
                                            <th><center><?php echo htmlspecialchars($resl1[ 'nama']); ?></center></th>
                                            <th><center><?php echo htmlspecialchars($resl1[ 'gbrqrcode']); ?></center></th>
                                ...
                                <!-- Script menampilkan total data -->               
                                    <?php 
                                        $tampil1 = "SELECT * FROM log_qrcode3";
    ...
    <script>
	  history.pushState({}, "", '/gate/admin/riwayataktivitas/riwayat-aktivitas-qrcode-vegetasi/');
	</script>    
