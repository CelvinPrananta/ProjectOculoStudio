...
mysqli_query($koneksi,"update paket3 set nama_paket='$nama_paket', keterangan_paket='$keterangan_paket', tgl_aktivitas='$tgl_aktivitas', username_detail='$username_detail' where id='$id'");
