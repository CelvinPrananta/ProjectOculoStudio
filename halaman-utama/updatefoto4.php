...
if($namafoto != null){
    ...
    $terupload = move_uploaded_file($file_tmp, 'assets/paket_4/'.$namafoto);
}else{
...
$query = mysqli_query($koneksi,"UPDATE paket4 SET tgl_uploadfoto='$tgl_uploadfoto', username='$username', foto_paket4='$namafoto' where id='$id'");
...
header("location:/gate/admin/halaman-utama/?pesan=perbaharuipaket4");
?>